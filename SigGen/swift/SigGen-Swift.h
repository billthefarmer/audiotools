...
#ifndef SIGGEN_ARM_SWIFT_H
#define SIGGEN_ARM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SigGen_arm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10SigGen_arm11AppDelegate")
...
SWIFT_CLASS("_TtC10SigGen_arm10SigGenView")
...
SWIFT_CLASS("_TtC10SigGen_arm11DisplayView")
@interface DisplayView : SigGenView
- (void)drawRect:(NSRect)dirtyRect;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_PROTOCOL("_TtP10SigGen_arm15EditMenuActions_")
...
SWIFT_CLASS("_TtC10SigGen_arm8KnobView")
...
SWIFT_CLASS("_TtC10SigGen_arm9ScaleView")
@interface ScaleView : SigGenView
- (void)drawRect:(NSRect)dirtyRect;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
