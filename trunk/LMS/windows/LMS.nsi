...
!define PRODUCT_NAME "Level Measuring Set"
!define PRODUCT_VERSION "1.0"
!define PRODUCT_PUBLISHER "Bill Farmer"
!define PRODUCT_WEB_SITE "http://audiotools.googlecode.com"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\LMS.exe"
!define PRODUCT_UNINST_NAME "UninstLMS.exe"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\LMS.exe"
!define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\LMS.txt"
...
Name "${PRODUCT_NAME}"
OutFile "SetupLMS-${PRODUCT_VERSION}.exe"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\${PRODUCT_NAME}.lnk" "$INSTDIR\LMS.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\LMS.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\${PRODUCT_UNINST_NAME}"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\LMS.exe"
...
Section Uninstall
  ...
  Delete "$INSTDIR\LMS.txt"
  Delete "$INSTDIR\COPYING"
  Delete "$INSTDIR\LMS.exe"
