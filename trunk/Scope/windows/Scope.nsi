...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\Scope.exe"
!define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\Scope.txt"
...
Name "${PRODUCT_NAME}"
OutFile "SetupScope-${PRODUCT_VERSION}.exe"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\${PRODUCT_NAME}.lnk" "$INSTDIR\Scope.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\Scope.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\${PRODUCT_UNINST_NAME}"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\Scope.exe"
...
Section Uninstall
  ...
  Delete "$INSTDIR\Scope.txt"
  Delete "$INSTDIR\COPYING"
  Delete "$INSTDIR\Scope.exe"
