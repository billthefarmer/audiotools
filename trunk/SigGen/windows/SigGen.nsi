...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\SigGen.exe"
!define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\SigGen.txt"
...
Name "${PRODUCT_NAME}"
OutFile "SetupSigGen-${PRODUCT_VERSION}.exe"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\${PRODUCT_NAME}.lnk" "$INSTDIR\SigGen.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\SigGen.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\${PRODUCT_UNINST_NAME}"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\SigGen.exe"
...
Section Uninstall
  ...
  Delete "$INSTDIR\SigGen.txt"
  Delete "$INSTDIR\COPYING"
  Delete "$INSTDIR\SigGen.exe"
