...
#ifndef SCOPE_ARM_SWIFT_H
#define SCOPE_ARM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Scope_arm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Scope_arm11AppDelegate")
...
SWIFT_PROTOCOL("_TtP9Scope_arm15EditMenuActions_")
...
SWIFT_CLASS("_TtC9Scope_arm9ScopeView")
...
SWIFT_CLASS("_TtC9Scope_arm10XScaleView")
...
SWIFT_CLASS("_TtC9Scope_arm10YScaleView")
