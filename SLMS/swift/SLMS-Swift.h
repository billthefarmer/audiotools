...
#ifndef SLMS_ARM_SWIFT_H
#define SLMS_ARM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SLMS_arm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8SLMS_arm11AppDelegate")
...
SWIFT_CLASS("_TtC8SLMS_arm8SLMSView")
...
SWIFT_CLASS("_TtC8SLMS_arm11DisplayView")
@interface DisplayView : SLMSView
...
SWIFT_PROTOCOL("_TtP8SLMS_arm15EditMenuActions_")
@protocol EditMenuActions
- (void)redo:(id _Nonnull)sender;
- (void)undo:(id _Nonnull)sender;
@end


SWIFT_CLASS("_TtC8SLMS_arm8KnobView")
...
SWIFT_CLASS("_TtC8SLMS_arm9MeterView")
@interface MeterView : SLMSView
@property (nonatomic) float level;
- (void)drawRect:(NSRect)dirtyRect;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8SLMS_arm9ScaleView")
@interface ScaleView : SLMSView
...
SWIFT_CLASS("_TtC8SLMS_arm12SpectrumView")
