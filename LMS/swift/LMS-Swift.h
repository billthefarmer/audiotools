...
#ifndef LMS_ARM_SWIFT_H
#define LMS_ARM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LMS_arm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7LMS_arm11AppDelegate")
...
SWIFT_CLASS("_TtC7LMS_arm7LMSView")
...
SWIFT_CLASS("_TtC7LMS_arm11DisplayView")
...
SWIFT_PROTOCOL("_TtP7LMS_arm15EditMenuActions_")
...
SWIFT_CLASS("_TtC7LMS_arm9MeterView")
...
SWIFT_CLASS("_TtC7LMS_arm12SpectrumView")
